// ignore_for_file: camel_case_types, use_key_in_widget_constructors, must_be_immutable, use_build_context_synchronously
...
class email_image extends StatelessWidget {
  String email;
  String subject;
  String body;
  email_image({
